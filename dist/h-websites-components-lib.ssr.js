...
var __vue_module_identifier__$y = "data-v-95448e14";
/* functional template */
...
}, __vue_inject_styles__$g, {}, __vue_scope_id__$g, __vue_is_functional_template__$g, __vue_module_identifier__$g, false, undefined, undefined, undefined);var Icons=/*#__PURE__*/Object.freeze({__proto__:null,IcBurger:__vue_component__$v,IcCart:__vue_component__$u,IcChevron:__vue_component__$t,IcExclamation:__vue_component__$s,IcFacebook:__vue_component__$r,IcGithub:__vue_component__$q,IcGlobe:__vue_component__$p,IcInstagram:__vue_component__$o,IcLinkedIn:__vue_component__$n,IcLock:__vue_component__$m,IcQuestion:__vue_component__$l,IcQuotes:__vue_component__$k,IcRevert:__vue_component__$j,IcTrash:__vue_component__$i,IcTwitter:__vue_component__$h,IcX:__vue_component__$g});var script$f = Vue__default["default"].extend({
  name: "HIcon",
  props: {
    title: String,
    iconName: String,
...
var __vue_render__$f = function __vue_render__() {
  ...
  }, [_vm._ssrNode((_vm.title ? "<title" + _vm._ssrAttr("id", _vm.iconName || _vm.icon) + " data-v-31c52510>" + _vm._ssrEscape("\n    " + _vm._s(_vm.title) + "\n  ") + "</title>" : "<!---->") + " "), _vm._ssrNode("<g data-v-31c52510>", "</g>", [_c(_vm.currentIcon, {
    tag: "component"
  })], 1)], 2);
};
...
var __vue_module_identifier__$f = "data-v-31c52510";
/* functional template */
